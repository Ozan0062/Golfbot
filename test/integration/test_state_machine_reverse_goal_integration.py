...
from config import (
    GOAL_POSITION_CM, GOAL_RELEASE_MARKER_PX,
...
class StateMachineReverseGoalTests(unittest.TestCase):
    ...
    def test_drive_goal_uses_driver_when_waypoints_are_done_and_heading_is_correct(self):
        ...
        controller._goal_approach_angle = 0.0
    ...
    def test_drive_goal_turns_when_final_heading_is_wrong(self):
        ...
        world = world_state(robot=(100.0, 60.0), robot_px=(500, 300), robot_angle=-10.0)
    ...
    def test_drive_goal_transitions_to_release_when_robot_is_at_goal(self):
        ...
        controller._goal_approach_angle = 0.0
        world = world_state(
            robot=(GOAL_POSITION_CM[0], GOAL_POSITION_CM[1]),
            robot_px=(GOAL_RELEASE_MARKER_PX[0], GOAL_RELEASE_MARKER_PX[1]),
            robot_angle=0.0,
        )
